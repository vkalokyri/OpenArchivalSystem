...
<% List<Book> bookList = (ArrayList<Book>)request.getAttribute("model");
...
<html>
    ...
    <body>
        <div id="wrap">
          ...
          <div id="RightMenu">
              <ul>                
                <li class="collectionHeader"><a style="font-size: 13px">Search Results</a></li>
                    ...
                    <div style="float:left; margin:10px;">                        
                        <div style="float:right;">
                            <table style="border: 1px solid gray;">
                                ...
                                <tr>
                                    <td><%=i+1%></td>
                                    <td><img onclick="" src="<%=bookList.get(i).getUri()%>" height="150px" width="100px"/></td>
                                </tr>                                
                                <tr>
                                    <td></td>
                                    <td><a href="Controller?action=showBookPage&collId=<%=((Collection)collectionList.get(i)).getId()%>&bookId=<%=bookList.get(i).getBookId()%>">"><%=bookList.get(i).getTitleList().get(0).getValue()%></a></td>
                                </tr>  
                                <%}%>
                             </table>   
                        </div>    
