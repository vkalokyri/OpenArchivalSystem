        ...
        <div id="wrap">
          ...
          <div id="RightMenu">
              <ul>                
                ...
                <form name ="collectionMetadata"  method="Post"  action="Controller?action=showCollectionUpdatePage&collId=-1">
                    <div class="gray">
                    ...
                    <div style="float:left; margin:10px;">                              
                        <table id="dataTable">                            
                            <tr>
                                ...
                                <td>Lang:</td>
                                <td><input id="titleLang" style="width:139px" type="text" name="titleLang"/></td>
