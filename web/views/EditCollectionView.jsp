        ...
        <div id="wrap">
          ...
          <div id="RightMenu">
              <ul>                
                ...
                <form name ="collectionMetadata"  method="Post"  action="Controller?action=showCollectionUpdatePage&collId=<%=current.get(0)%>">
                    <div class="gray">
                    ...
                    <div style="float:left; margin:10px;">                              
                        <table id="dataTable">
                            <%if(collection.getTitleList()!=null){
                                    ...
                                    <tr>
                                        <td>Title:</td>
                                        <td><input style="width:273px" type="text" name="title" value="<%=((LangString)collection.getTitleList().get(j)).getValue()%>"/></td>
                                        <td>Lang:</td>
                                        <td><input id="titleLang_<%=j%>" style="width:139px" type="text" name="titleLang" value="<%=((LangString)collection.getTitleList().get(j)).getLang()%>" /></td>
                                        <td><img style="float:left; cursor:pointer" src="images/delete.gif" onclick="deleteRow('dataTable',this)"/></td>
                                    </tr>
                                <%}}%> 
                            <tr>
                                <td colspan="4"><a style="cursor:pointer" onclick="addRow('dataTable','Title:', '1', 'title')"><img style="cursor:pointer" src="images/add.jpg"/> add title</a></td>
                            </tr>
                        </table>                       
                    </div>
                 </form> 
