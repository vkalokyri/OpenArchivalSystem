 ...
 * @author ganest
 */
public class ShowDeletedPage implements Action {
   ...
   public boolean execute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
       ...
       if(bookId!=null)
        ...
        if(bookId!=null){
            DAOFactory.getDAOFactory(DAOFactory.EXIST).getBookDAO().deleteBook(bookId,collId);
            view = "./views/ShowCollectionView.jsp";
        }else{
            DAOFactory.getDAOFactory(DAOFactory.EXIST).getCollectionDAO().deleteCollection(collId);
